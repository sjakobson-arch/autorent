        ...
        <div class="col-md-4">
            <div class="card shadow-sm mb-4">
                <div class="card-body d-flex align-items-center">
                    ...
                    <!-- UUS AUTO IKoon -->
                    <svg xmlns="http://www.w3.org/2000/svg" width="48" height="48" fill="#0d6efd" class="me-3" viewBox="0 0 16 16">
                        <path d="M4 9a1 1 0 1 1-2 0 1 1 0 0 1 2 0zm10 1a1 1 0 1 0 0-2 1 1 0 0 0 0 2z"/>
                        <path d="M0 7l1-2h14l1 2v5h-1a2 2 0 1 0-4 0H6a2 2 0 1 0-4 0H1V7z"/>
                    </svg>
